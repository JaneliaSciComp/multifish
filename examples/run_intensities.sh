...
#$DIR/../main-quantify-spots.nf -profile lsf --lsf_opts "-P multifish" \
$DIR/../main-quantify-spots.nf -profile localsingularity \
    ...
    --warped_spots=/nrs/scicompsoft/goinac/multifish/ex1/LHA3_R5_subset/registration/LHA3_R5_subset-to-LHA3_R3_subset/warped \
